...
const MainPage = () => {
  ...
  return (
    <div style={{ 
      ...
      background: 'linear-gradient(to bottom, #0D47A1, #1976D2)' // Degradê de azul escuro
    }}>
      <h1 style={{ 
        color: '#f66b0e', 
        fontSize: '3.5rem', 
        marginBottom: '20px',
        textShadow: '2px 2px 4px rgba(0, 0, 0, 0.3)' // Sombreamento do texto
      }}>
        Teacher Desk
      </h1>
      <p style={{ 
        ...
        fontSize: '1.5rem', 
        color: '#E3F2FD',
        maxWidth: '600px', // Limita a largura do texto
      ...
      <button
        ...
        onMouseEnter={e => e.currentTarget.style.backgroundColor = '#e65c00'} // Efeito ao passar o mouse
